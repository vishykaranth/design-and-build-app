...
import expressiontree.tree.SynchronizedExpressionTree;
...
public class IteratorFactory {
    ...
    public Iterator<ExpressionTree> makeIterator(SynchronizedExpressionTree expressionTrees, String traversalOrder) {
        return null;
    }
